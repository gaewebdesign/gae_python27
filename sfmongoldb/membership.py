...
class MassEnterHandler(webapp2.RequestHandler):
    ...
    def get(self):
         ...
         r=Player( year=2017,fname="Laura ",lname="Fletcher ",email="fletch4him1@mac.com",ntrp="F3.5",address="869 Hilmar Street",city="Santa Clara",zip="95050",mtype="RF",src="PP",id=1484298150).put()
         print(r)
         print("done ")
